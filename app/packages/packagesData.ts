export const packagesData = [
  {
    ...
    itinerary: [
      ...
      'Scenic cruise through Godavari River',
      'Papikondalu sightseeing and return journey'
    ],
    bestTime: 'October to March',
    inclusions: ['Transportation', 'Boat ride', 'Guide services', 'Temple entry'],
    highlights: ['Sacred temple visit', 'River cruise', 'Mountain views', 'Photography'],
    tips: ['Carry valid ID for temple entry', 'Wear comfortable clothes', 'Book in advance during peak season']
  },
  {
    id: 2,
    ...
    itinerary: [
      ...
      'Papikondalu exploration and overnight stay',
      'Continue to Rajahmundry with sightseeing'
    ],
    bestTime: 'November to February',
    inclusions: ['Accommodation', 'All meals', 'Transportation', 'Guide services', 'Entry fees'],
    highlights: ['Multi-day cruise', 'Temple visits', 'Cultural sites', 'Scenic beauty'],
    tips: ['Pack light luggage', 'Carry medicines', 'Book well in advance', 'Check weather conditions']
  },
  {
    id: 3,
  ...
  },
  {
    ...
    itinerary: [
      ...
      'Papikondalu exploration and activities',
      'Bhadrachalam temple visit and conclusion'
    ],
    bestTime: 'November to February',
    inclusions: ['Accommodation', 'Meals', 'Transportation', 'Temple entry', 'Cultural programs'],
    highlights: ['Cultural immersion', 'Temple darshan', 'River journey', 'Local traditions'],
    tips: ['Respect temple customs', 'Carry traditional clothes', 'Learn about local culture', 'Book temple accommodation']
  },
  {
    id: 5,
  ...
  },
  {
    ...
    itinerary: [
      ...
      'Camp activities and overnight stay',
      'Morning activities and return'
    ],
    bestTime: 'October to March',
    inclusions: ['River transport', 'Camping gear', 'Meals', 'Activities', 'Safety measures'],
    highlights: ['River to camp journey', 'Outdoor adventures', 'Night camping', 'Nature activities'],
    tips: ['Pack light', 'Carry personal medicines', 'Wear comfortable clothes', 'Respect nature']
  },
  {
    id: 7,
